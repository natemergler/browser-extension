...
1. Start RabbitTrail backend on `localhost:3002`
...
1. Run `pnpm dev` to build with monitoring
...
- Tests currently disabled; `pnpm test` only prints a reminder
